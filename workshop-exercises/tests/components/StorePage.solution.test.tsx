/**
 * Exercise D solution — StorePage component tests.
 *
 * Participants fill in CartPage.test.tsx; this file is the reference answer
 * available on the 04-integration-testing branch.
 */
